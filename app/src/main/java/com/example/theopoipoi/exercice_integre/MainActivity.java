        ...
        sign_in_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //if (validate()) {
                    ...
                    if (currentUser != null) {
                        Snackbar.make(sign_in_button, "Successfully Logged in!", Snackbar.LENGTH_LONG).show();
                       ...
                       /* Intent intent=new Intent(LoginActivity.this,HomeScreenActivity.class);
                        ...
                        Snackbar.make(sign_in_button, "Failed to log in , please try again", Snackbar.LENGTH_LONG).show();
